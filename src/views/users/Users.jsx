...
const Users = () => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NmFhNWI4ZjEzM2JlNTNlYWEwYTVkMzYiLCJ1c2VyUm9sZSI6ImN1c3RvbWVyIiwiaWF0IjoxNzMwMjMxNDk1LCJleHAiOjE3MzAyMzUwOTV9.Y4tkVY-zWWLLiisbhmdTv_qPd6jqLHQdYf5mO7NVyKg"

    // Fetch users data
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                let res = await axios.get('http://127.0.0.1:8050/api/v1/auth/users', {
                    headers: {
